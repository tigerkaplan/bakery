    ...
    <section className="min-h-[780px]">
      ...
      <div className="bg-blue-200 relative z-10 top-72 lg:top-52">
        ...
        >
          ...
          <motion.div variants={fadeIn("down", "tween", 0.6, 1.6)} className="">
                ...
                return (
                  <div key={index}>
                    <div className="flex flex-row lg:flex-col h-full">
                      {/* image */}
                      {/* reverse order for 1and 3   */}
                      <div
                        className={`w-[45%] md:w-auto ${index === 1 ||
                        index === 3
                          ? "lg:order-1"
                          : "order-none"}`}
                      >
                      ...
                      <div className="bg-[#fff3e4] flex-1 flex flex-col justify-center px-6 lg:p-12 lg:max-h-[250px] xl:max-h-max">
                        <div className="text-center">
                          <div className="text-xl font-semibold text-dark lg:text-2xl">
                            {name}
                          </div>
