...
<form className='flex flex-col lg:flex-row lg:gap-x-[10px] gap-y-4'>
  <input className='input bg-transparent placeholder:font-light placeholder:text-white/20 text-white focus:ring-1 focus:ring-accent border border-white/20 ' type='text'/>
